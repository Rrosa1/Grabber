...
public enum CipherSuites {
    ...
    public String Null_cipher() {
        return TLS_ECDHE_RSA_WITH_NULL_SHA.getStringValue() + TLS_ECDHE_ECDSA_WITH_NULL_SHA.getStringValue() +
    ...
    public String Anonymous_NULL_Ciphers() {
        return TLS_ECDH_ANON_WITH_AES_256_CBC_SHA.getStringValue() + TLS_DH_ANON_WITH_AES_256_GCM_SHA384.getStringValue() +
    ...
    public String Anonymous_DH_Ciphers() {
        return TLS_DH_ANON_WITH_AES_256_GCM_SHA384.getStringValue() + TLS_DH_ANON_WITH_AES_256_CBC_SHA256.getStringValue() +
    ...
    public String Expot_40() {
        return TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA.getStringValue() + TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA.getStringValue() +
    ...
    public String LOW() {
        return TLS_DHE_RSA_WITH_DES_CBC_SHA.getStringValue() + TLS_DHE_DSS_WITH_DES_CBC_SHA.getStringValue() +
                TLS_RSA_WITH_DES_CBC_SHA.getStringValue();
    }

    public String DES_Ciphers() {
        return LOW();
    }

    public String Medium() {
        return TLS_DHE_RSA_WITH_SEED_CBC_SHA.getStringValue() + TLS_DHE_DSS_WITH_SEED_CBC_SHA.getStringValue() +
    ...
    public String DES3() {
        return TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA.getStringValue() + TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA.getStringValue() +
    ...
    public String HIGH() {
        return TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384.getStringValue() + TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384.getStringValue() +
